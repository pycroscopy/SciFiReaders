...
if __name__ == '__main__':
    datafolder_path = Path(__file__).resolve().parent.parent.parent.parent.parent.parent / 'downloads' /'wsxm'
    ...
    data_file_path = str(datafolder_path / 'WSxM1DReader_spectrocurve_0001_Normalforce.f.curves')
    ...
    data_file_path = str(datafolder_path / 'WSxM3DReader_Forcevolume_0003_Normalforce.ff.ch1.gsi')
